...
| Public session header and auth boundaries | Hecho | `docs/task-specs/marketplace-discovery-mvp/07-public-session-header-and-auth-boundaries.md` | `0.8`, `0.10`, `0.12`, `6.1`, `7.2`, `8.1`, `11.13`, `11.14`, `11.15` | Header publico unificado, single active session y admin read-only en flujos publicos. |
...
| 11.13 | Crear pagina publica de resultados de busqueda `/search`. | [ ] | [x] | [x] | [ ] |
| 11.14 | Mostrar cards publicas de business con ciudad, categoria y services destacados. | [ ] | [x] | [x] | [ ] |
| 11.15 | Navegar desde resultado de busqueda a perfil publico y flujo de appointment. | [ ] | [x] | [x] | [ ] |
