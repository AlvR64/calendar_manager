...
/// <summary>Payload for updating a staff member availability exception on a specific date.</summary>
public sealed record UpdateStaffMemberAvailabilityExceptionRequest
{
